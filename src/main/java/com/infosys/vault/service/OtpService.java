...
public class OtpService {
    ...
    public void sendShareNotificationEmail(com.infosys.vault.dto.ShareEmailRequest request) {
        ...
        System.out.println("==================================================");
        System.out.println(">>> SENDING SHARE LINK EMAIL TO [" + cleanEmail + "] FOR ITEM [" + title + "] <<<");
        System.out.println("==================================================");
        ...
        java.util.concurrent.CompletableFuture.runAsync(() -> {
            try {
                ...
                helper.setSubject("Secure Credential Share: " + title);
                ...
                String htmlContent = "<div style=\"font-family: 'Segoe UI', Arial, sans-serif; max-width: 540px; margin: 0 auto; padding: 28px; background-color: #0b1329; border-radius: 16px; color: #f1f5f9; border: 1px solid #1e293b;\">"
                        ...
                        + "<h3 style=\"color: #ffffff; font-size: 18px; margin: 0 0 8px 0; text-align: center;\">You've received a secure credential secret!</h3>"
                        + "<p style=\"color: #94a3b8; font-size: 13px; text-align: center; margin-top: 0; margin-bottom: 20px;\">Item Title: <strong style=\"color: #38bdf8;\">" + title + "</strong> (" + exp + ")</p>"
                ...
                LOGGER.log(Level.WARNING, "Failed to send Share Notification Email to {0}: {1}", new Object[]{cleanEmail, e.getMessage()});
            }
        });
    }
}
