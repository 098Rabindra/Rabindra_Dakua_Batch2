      ...
      <div className="flex items-center justify-between border-b border-white/[0.06] pb-3">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>Password Health Report</span>
          </button>
          ...
          {activeReportTab === 'PASSWORD_HEALTH' && (
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                {/* Health Score % */}
                <div className="glass-panel p-4 flex flex-col justify-between border-cyan-500/20 bg-cyan-500/[0.02] shadow-lg relative overflow-hidden">
                  <div className="flex items-center justify-between">
                ...
                {finalLogin.recentActivities.length === 0 ? (
                  ...
                  <div className="overflow-x-auto custom-scrollbar">
                    <table className="w-full text-left border-collapse text-xs">
                      <thead>
                        <tr className="border-b border-white/[0.08] text-[10px] uppercase tracking-wider text-slate-400 font-bold bg-white/[0.02]">
                        ...
                        {finalLogin.recentActivities.map((log, index) => {
                          ...
                          return (
                            <tr key={log.id || index} className="hover:bg-white/[0.02] transition">
                              ...
                              <td className="py-3 px-4 font-medium text-slate-200">{log.email || log.username || 'System User'}</td>
                              ...
                              <td className="py-3 px-4 text-slate-300">{log.activity}</td>
