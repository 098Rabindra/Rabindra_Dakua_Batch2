...
export default function DashboardPage() {
  ...
  const handleOpenShare = (itemToShare) => {
    let target = itemToShare;
    if (!target) {
      target = vaultItems.find((i) => !i.permissionLevel || i.permissionLevel === 'FULL_MANAGEMENT');
    }
    ...
    if (!target) {
      if (vaultItems.length === 0) {
        ...
        showToast('Permission Denied: No credentials in your vault with Full Management permission for sharing.');
      }
      return;
    }
  ...
  const handleImportSingleItem = async (payload) => {
    ...
    if (isDup) {
      throw new Error(`Vault item "${payload.title}" already exists`);
    }
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-2 z-10">
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition duration-200 shrink-0 ${
                          item.favorite
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-white/[0.04] z-10">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg border border-transparent transition text-slate-500 hover:text-rose-400 hover:bg-white/[0.03]"
