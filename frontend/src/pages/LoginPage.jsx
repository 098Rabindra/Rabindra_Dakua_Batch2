        ...
        <div className="glass-panel p-8 shadow-premium border-slate-800/80">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  placeholder="••••••••••••••••"
                  className={`glass-input font-mono pl-11 pr-11 transition-all duration-200 ${fieldErrors.password ? 'border-amber-500/70 focus:border-amber-400 focus:ring-amber-500/20 text-amber-100 placeholder:text-slate-500 shadow-[0_0_10px_rgba(245,158,11,0.15)]' : ''}`}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary py-3 text-sm mt-4 w-full shadow-indigo-500/20 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200"
            >
