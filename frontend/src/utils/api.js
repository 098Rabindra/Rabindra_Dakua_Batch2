...
export const vaultApi = {
  ...
  sendShareEmail: (recipientEmail, shareLink, itemTitle, expiration, token) =>
    apiRequest('/vault/share-email', 'POST', { recipientEmail, shareLink, itemTitle, expiration }, token),
};
