...
export const vaultApi = {
  ...
  sendShareEmail: (recipientEmail, shareLink, itemTitle, expiration, permissionLevel, passcode, senderEmail, token) =>
    apiRequest('/vault/share-email', 'POST', { recipientEmail, shareLink, itemTitle, expiration, permissionLevel, passcode, senderEmail }, token),
};
