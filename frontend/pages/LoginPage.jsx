  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        html: `<p style="color:#94a3b8;font-size:14px;margin-top:4px">Welcome back, <strong style="color:#818cf8">${authResult.userData.username}</strong>!<br/>Vault AES encryption key derived successfully.<br/>Opening your secure dashboard...</p>`,
        icon: 'success',
        iconColor: '#6366f1',
        background: '#0f172a',
        color: '#f1f5f9',
        ...
        <div className="glass-panel p-8 shadow-premium border-slate-800/80">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 mt-2.5 flex items-center gap-1.5 leading-relaxed">
